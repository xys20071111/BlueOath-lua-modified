...
local lei2str = function(i)
  local f = function(s)
    return char(bit_and(bit_rshift(i, s), 255))
  end
  return f(0) .. f(8) .. f(16) .. f(24)
end
local str2bei = function(s)
  local v = 0
  for i = 1, #s do
    v = v * 256 + byte(s, i)
  end
...
local transform = function(A, B, C, D, X)
...
local md5_update = function(self, s)
  self.pos = self.pos + #s
  s = self.buf .. s
  for ii = 1, #s - 63, 64 do
...
local md5_finish = function(self)
