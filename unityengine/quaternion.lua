...
function Quaternion.Lerp(q1, q2, t)
  t = clamp(t, 0, 1)
  local q = _new()
  if 0 > Quaternion.Dot(q1, q2) then
...
xlua.setmetatable(CS.UnityEngine.Quaternion, Quaternion)
xlua.setclass(CS.UnityEngine, "Quaternion", Quaternion)
