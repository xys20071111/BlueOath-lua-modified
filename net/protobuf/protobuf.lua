...
local type = type
local pb = require("pb")
local wire_format = require("net.protobuf.wire_format")
local type_checkers = require("net.protobuf.type_checkers")
local encoder = require("net.protobuf.encoder")
local decoder = require("net.protobuf.decoder")
local listener_mod = require("net.protobuf.listener")
local containers = require("net.protobuf.containers")
local descriptor = require("net.protobuf.descriptor")
local FieldDescriptor = descriptor.FieldDescriptor
local text_format = require("net.protobuf.text_format")
local protobuf = {}
local _M = protobuf
local g = _G
local rawget = rawget
...
_ENV = setmetatable({}, {
  __index = function(t, k)
    return rawget(_M, k) or rawget(g, k)
  end,
  __newindex = _M
})
...
_M.Message = Message
_M.property_getter = property_getter
return _M
